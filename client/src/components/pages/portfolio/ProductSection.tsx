...
export const ProductSection = () => {
   ...
   const handleBuyBtn = async (productTitle: string) => {
      const phone = await getPhone();

      const message = `Hola, me gustaría comprar el producto "${productTitle}"`;
      ...
      <>
         <div className="animate-in fade-in duration-400">
            ...
            <div className="text-center mb-16">
               <h2 className="text-4xl font-thin tracking-wide mb-6">Productos</h2>
